        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadquartersLocation = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalType = table.Column<string>(type: "varchar(20)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalBooksInShelf = table.Column<int>(type: "int", nullable: false),
                    TotalPagesRead = table.Column<int>(type: "int", nullable: false),
                    MostReadGenreId = table.Column<int>(type: "int", nullable: false),
                    BookWithLeastPagesId = table.Column<int>(type: "int", nullable: false),
                    BookWithMostPagesId = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Statistics_Books_BookWithLeastPagesId",
                        column: x => x.BookWithLeastPagesId,
                        principalTable: "Books",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Statistics_Books_BookWithMostPagesId",
                        column: x => x.BookWithMostPagesId,
                        principalTable: "Books",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Statistics_Genres_MostReadGenreId",
                        column: x => x.MostReadGenreId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Statistics_BookWithLeastPagesId",
                table: "Statistics",
                column: "BookWithLeastPagesId");

            migrationBuilder.CreateIndex(
                name: "IX_Statistics_BookWithMostPagesId",
                table: "Statistics",
                column: "BookWithMostPagesId");

            migrationBuilder.CreateIndex(
                name: "IX_Statistics_MostReadGenreId",
                table: "Statistics",
                column: "MostReadGenreId");
